...
# Video placeholder
video_placeholder_color = (150, 150, 150)  # Gray color for the placeholder
video_placeholder_rect = pygame.Rect(0, 0, 320, 240)  # Rectangle for the placeholder
...
def main():
    ...
    while running:
        ...
        screen.fill(WHITE)
        pygame.draw.rect(screen, video_placeholder_color, video_placeholder_rect)
        gui.draw(screen)
        pygame.display.flip()
